...
class Rectangle:
    ...
    def square(cls, size=0):
        """
        Change the dimensions for a rectangle. The new
        dimension alters the rectangle into a square

        Parameters
        size : integer, optional
            The new width and height for our rectangle
        """

        new_rectangle = Rectangle(height=size, width=size)
